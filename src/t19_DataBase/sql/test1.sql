...
insert into test values ('김말숙', 30, '여성', '청주');					--	레코드 삽입
insert into test values ('오하늘', default, default, '');					--	레코드 삽입
insert into test (name) values ('이사랑');					--	레코드 삽입
insert into test values ('가나다', 30, '남성', '청주');					--	레코드 삽입
insert into test values ('아톰', 35, '남성', '제주');					--	레코드 삽입
insert into test values ('강감찬', 42, '남성', '인천');					--	레코드 삽입
insert into test values ('이사랑', 21, '여성', '서울');					--	레코드 삽입
insert into test values ('강소연', 19, '여성', '청주');					--	레코드 삽입
insert into test values ('고릴라', 38, '여성', '제주');					--	레코드 삽입
insert into test values ('김감자', 41, '남성', '서울');					--	레코드 삽입
insert into test values ('이자바', 30, '여성', '청주');					--	레코드 삽입
insert into test values ('김자월', 30, '여성', '제주');					--	레코드 삽입
insert into test values ('오자월', 22, '여성', '제주');					--	레코드 삽입
insert into test values ('오이자월', 22, '여성', '제주');					--	레코드 삽입
insert into test values ('김자월화', 36, '여성', '청주');					--	레코드 삽입
